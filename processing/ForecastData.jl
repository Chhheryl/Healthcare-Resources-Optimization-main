...
function load_ihme(;forecast_date::String="2020-06-13")
	forecast_data = DataFrame(CSV.File("../data/forecasts/ihme/$(forecast_date)/forecast.csv"), copycols=true)

	state_list = DataFrame(CSV.File("../data/geography/states.csv"), copycols=true)
